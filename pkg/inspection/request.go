...
func (c *Server) populateClusterTotalKeyMetrics(cluster *etcdv1alpha1.EtcdCluster, nodes []*mvccpb.KeyValue) {
...
func (c *Server) Watch(cluster *etcdv1alpha1.EtcdCluster, client *clientv3.Client, keyPrefix string) error {
...
func (c *Server) watch(cluster *etcdv1alpha1.EtcdCluster, wchan clientv3.WatchChan) error {
...
func (c *Server) processWatchEvent(cluster *etcdv1alpha1.EtcdCluster) {
	ch := c.getEventCh(cluster.Name)
	labels := map[string]string{
		"clusterName": cluster.Name,
	}
