...
import (
	v1alpha1 "etcd-operator/pkg/generated/clientset/versioned/typed/etcd/v1alpha1"
...
func (c *FakeEtcdV1alpha1) EtcdInspections(namespace string) v1alpha1.EtcdInspectionInterface {
