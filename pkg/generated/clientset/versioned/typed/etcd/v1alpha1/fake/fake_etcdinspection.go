...
var etcdinspectionsResource = schema.GroupVersionResource{Group: "etcd.clay.io", Version: "v1alpha1", Resource: "etcdinspections"}

var etcdinspectionsKind = schema.GroupVersionKind{Group: "etcd.clay.io", Version: "v1alpha1", Kind: "EtcdInspection"}
...
func (c *FakeEtcdInspections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(etcdinspectionsResource, c.ns, name, opts), &v1alpha1.EtcdInspection{})
