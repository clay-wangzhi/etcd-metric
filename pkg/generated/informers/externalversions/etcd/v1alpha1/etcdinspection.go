...
import (
	...
	v1alpha1 "etcd-operator/pkg/generated/listers/etcd/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EtcdV1alpha1().EtcdInspections(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EtcdV1alpha1().EtcdInspections(namespace).Watch(context.TODO(), options)
			},
		},
		&etcdv1alpha1.EtcdInspection{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *etcdInspectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&etcdv1alpha1.EtcdInspection{}, f.defaultInformer)
}
